...
& and the the degree of $f_i$ = $d_i$ = $d$ \\
& which is the largest degree among all\\
& the polynomials and $f_i$ has the\\
& co-efficient $a_i$\\
& \\
& then if $a_1f_1+a_2f_2+...+a_nf_n=\theta$\\
& and $d_i=d \neq d_j$ for j=1,2,....,n and\\
& $i \neq j$\\
& then it must be $a_i=0$\\
& \\
& Now, consider the second largest degree $d_k$\\
& and it is the degree of the polynomial $f_k$\\
& $a_k$ is the coefficient of $f_k$\\
& $d_k \neq d_j$ for j=1,2,....,n and\\
& $k \neq j$, so similarly $a_k=0$\\
& \\
